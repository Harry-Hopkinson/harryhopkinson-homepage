        ...
        <Container>
            ...
            <SimpleGrid columns={[1, 1, 2]} gap={6}>
                <Section>
                    ...
                    >
                        SnowBallBrawl - A Two Player Game in which you fight
                        with Snowballs.
                    </WorkGridItem>
                </Section>
                <Section>
                ...
                <Section delay={0.1}>
                    ...
                    >
                        A Place to Manage, Explore and Review Books from Your
                        Browser.
                    </WorkGridItem>
                </Section>
                <Section delay={0.1}>
                    <WorkGridItem
                        id="https://github.com/Harry-Hopkinson/Notebook-TODO"
                        thumbnail={thumbNoteBookTODO}
                        title="NoteBook TODO"
                    >
                        A Notebook to Store Ideas and Code Snippets. Can Import
                        Images and Graphs to Help Consolodate Knowledge.
                    </WorkGridItem>
                </Section>
            </SimpleGrid>
        </Container>
