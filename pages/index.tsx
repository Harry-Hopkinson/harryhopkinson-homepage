  ...
  <Layout title={undefined}>
    <Container>
      ...
      <Section delay={0.1}>
        ...
        <Paragraph>
          Harry is a Junior Programmer from England who has a passion for the
          subject. He loves coding and has dabbled in all sorts of programming
          languages. His favourites are Python, Javascript/Typescript, Java and
      ...
      <Section delay={0.2}>
        ...
        <BioSection>
          ...
          called SnowBallBrawl on Itch.io built using Unity.
        </BioSection>
        <BioSection>
